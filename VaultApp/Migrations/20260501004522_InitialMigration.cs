    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(nullable: false),
                    EncryptionKeyHash = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    VaultEntryId = table.Column<int>(nullable: false),
                    SharedWithUserId = table.Column<string>(nullable: false),
                    ReEncryptedKey = table.Column<string>(nullable: false),
                    ReEncryptedIV = table.Column<string>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SharedEntries_AspNetUsers_SharedWithUserId",
                        column: x => x.SharedWithUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SharedEntries_VaultEntries_VaultEntryId",
            ...
            migrationBuilder.CreateIndex("IX_SharedEntries_SharedWithUserId", "SharedEntries", "SharedWithUserId");
            migrationBuilder.CreateIndex("IX_SharedEntries_VaultEntryId", "SharedEntries", "VaultEntryId");
            migrationBuilder.CreateIndex("IX_VaultEntries_OwnerId", "VaultEntries", "OwnerId");
        }

        /// <inheritdoc />
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DropTable("SharedEntries");
            migrationBuilder.DropTable("AspNetRoleClaims");
            migrationBuilder.DropTable("AspNetUserClaims");
            migrationBuilder.DropTable("AspNetUserLogins");
            migrationBuilder.DropTable("AspNetUserRoles");
            migrationBuilder.DropTable("AspNetUserTokens");
            migrationBuilder.DropTable("VaultEntries");
